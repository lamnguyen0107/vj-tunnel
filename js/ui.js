...
export class UIController {
  constructor(callbacks) {
    ...
    this.els = {
      ...
      labelAutoColor: document.getElementById('label-auto-color'),
    };
    ...
    this._translations = {
      vi: {
        ...
        sectionAudio: 'ÂM THANH & OBJECT',
        sectionControls: 'ĐIỀU CHỈNH TUNNEL',
      ...
      en: {
        ...
        cloneCount: 'Object Count',
        objectSize: 'Object Size',
        objectRotX: 'Angle X',
        objectRotY: 'Angle Y',
        objectRotZ: 'Angle Z',
        cloneFreeFly: 'Free-Fly Objects',
        randomize: 'Randomize',
        volume: 'Volume',
        speed: 'Speed',
  ...
  _bindEvents() {
    ...
    // Color
    if (this.els.autoColorToggle) {
      this.els.autoColorToggle.addEventListener('change', e => {
        if (this.callbacks.onAutoColorModeChange) this.callbacks.onAutoColorModeChange(e.target.checked);
      });
    }
  ...
  setAutoColorMode(enabled) {
    if (this.els.autoColorToggle) {
      this.els.autoColorToggle.checked = Boolean(enabled);
    }
  }
  ...
  applyLanguage(lang) {
    ...
    if (this.els.labelAutoColor) this.els.labelAutoColor.textContent = t.autoColor;
